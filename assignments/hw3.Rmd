...
with the equation:
    ...
    where acetate is oxidized by $O_2$ as the final electron acceptor. Note the terminology
    is confusing `oxidizing` a substance means that that substance is `reduced`. Oxidizing
    is the act of taking electrons of a substance, thereby reducing it. For this reaction,
