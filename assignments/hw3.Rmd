...
6. What is the difference in standard free energy yields for these three reactions? {.build}


    $CH_3COOH + 2O_2 -> 2CO_2 + H_2O$
    
    $CH_3COOH + 1SO_4^{2-} + 2H^+  -> 2CO_2 + H_2S + 2H_2O$
    
    $CH_3COOH + 2NO_3^- + 4H^+ -> 2CO_2 + N_2 + 4H_2O$
